...
#define I2S_CONTROL_REG_SIGN_EXTEND		3
#define I2S_CONTROL_REG_SIGN_EXTEND_LEN	1
#define I2S_CONTROL_REG_LEFT_JUSTIFIED		4
#define I2S_CONTROL_REG_LEFT_JUSTIFIED_LEN	1
